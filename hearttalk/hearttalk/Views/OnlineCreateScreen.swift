...
//import SwiftUI
//
//struct OnlineCreateScreen: View {
//    
...
//                    TagsFillField(placeholder: "psycho", texts: $tags)
...
//        for myCardType in viewModel.packs.map({ $0.pack }) {
...
//            cardType.text = description.isEmpty ? Localization.descriptionPlaceholder : description
//            cardType.isCustom = true
//            viewModel.createPack(cardType, tags: tags)
//        case .card:
//            let card = Card(id: UUID().uuidString, question: text)
